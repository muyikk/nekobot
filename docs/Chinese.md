...
---
## ✨Updates 更新  
![](https://img.shields.io/badge/LatestVersion-2.0.0-blue?&logo=react)
### 新增
- 新增功能:
...
+ 快速添加命令
+ 配置要求低，轻量，占用内存小
+ 支持主动聊天功能，机器人会在合适的时间主动找你说话
+ 机器人拥有成长机制，每个群聊和私聊中都有独立的一生和不同阶段的性格表现
